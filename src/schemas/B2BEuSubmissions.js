...
// --- Begin: B2B Partner End Users Submissions Schema --- //
...
schema.index({sDtStr: -1, uDtStr: -1});

module.exports = mongoose.model(config.collB2BEuSubmissions, schema);
// --- End: B2B Partner End Users Submissions Schema --- //
