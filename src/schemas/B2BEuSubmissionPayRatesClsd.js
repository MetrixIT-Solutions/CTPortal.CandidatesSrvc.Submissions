...
// --- Begin: B2B Partner End Users Submission Pay Rates Closed Schema --- //
...
}, {collection: config.collB2BEuSubmissionPayRatesClsd});

schema.index({delFlag: -1, submission: 1, euUser: 1});
schema.index({cDtStr: -1});

module.exports = mongoose.model(config.collB2BEuSubmissionPayRatesClsd, schema);
// --- End: B2B Partner End Users Submission Pay Rates Closed Schema --- //
